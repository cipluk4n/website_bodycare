...
<head>
    ...
    <style>
        ...
        h2 {
            ...
            text-stroke: 20px #FF689D; */
            text-shadow: 3px 4px 5px #3e8188ff;
        }
    </style>
</head>
<body>
            ...
            <div class="container">
                <div class="profile-container">
                    <div class="profile-header">
                        ...
                        <h2 style="text-align:center"><?php echo htmlspecialchars($user['username']); ?></h2>
